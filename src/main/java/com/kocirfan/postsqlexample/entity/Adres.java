package com.kocirfan.postsqlexample.entity;
...
public class Adres implements Serializable {
    ...
    // bu sınıf veri tabanında tutulan bir entity'i temsil eder
    // ve yukarıda belirtilen annatationlar bunu nitelemek içindir
}
